...
const strengthTextColors = ["", "text-red-500", "text-orange-500", "text-blue-500", "text-green-500"];
const strengthBarColors = ["", "bg-red-500", "bg-orange-500", "bg-blue-500", "bg-green-500"];
...
export default function Register() {
  ...
  const handleChange = (field) => (e) => {
    ...
    if (field === "password") setStrength(calcStrength(val));
  };
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <div className="relative">
                <svg
                  className={`absolute left-3.5 top-1/2 -translate-y-1/2 transition-colors duration-200 ${focused === "username" ? "text-blue-500" : "text-zinc-600"}`}
            ...
            <div>
              ...
              <div className="relative">
                <svg
                  className={`absolute left-3.5 top-1/2 -translate-y-1/2 transition-colors duration-200 ${focused === "email" ? "text-blue-500" : "text-zinc-600"}`}
                  width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"
                >
            ...
            <div>
              ...
              <div className="relative">
                <svg
                  className={`absolute left-3.5 top-1/2 -translate-y-1/2 transition-colors duration-200 ${focused === "password" ? "text-blue-500" : "text-zinc-600"}`}
                  width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"
                >
                ...
                <div className="mt-2.5">
                  <div className="flex gap-1 mb-1.5">
                    {[1, 2, 3, 4].map((i) => (
                      <div
                        key={i}
                        className={`h-1 flex-1 rounded-full transition-colors duration-300 ${i <= strength ? strengthBarColors[strength] : "bg-zinc-800"}`}
                      />
                    ))}
                  </div>
            ...
            <label className="flex items-start gap-2.5 cursor-pointer mt-1">
              ...
              <span className="text-zinc-500 text-xs leading-relaxed">
                I agree to the{" "}
                <span className="text-blue-500 hover:text-blue-400 cursor-pointer transition-colors">Terms of Service</span>
                {" "}and{" "}
